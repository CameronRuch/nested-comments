...
app.put("/posts/:postId/comments/:commentId", async (req, res) => {
  ...
  if (userId !== req.cookies.userId) {
    return res.send(app.httpErrors.unauthorized("You can only edit your own comments!"))
  }
...
app.delete("/posts/:postId/comments/:commentId", async (req, res) => {
  ...
  if (userId !== req.cookies.userId) {
    return res.send(app.httpErrors.unauthorized("You can only delete your own comments!"))
  }
